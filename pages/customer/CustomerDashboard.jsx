...
const CustomerDashboard = ({ initialTab = 'all' }) => {
  console.log('🎯 Customer Dashboard loading at 2025-09-03 15:28:10');
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(`🔄 Fetching customer dashboard data from database at 2025-09-03 15:28:10`);
      ...
      console.log(`✅ Dashboard data loaded: ${carsData.length} cars, ${toursData.length} tours at 2025-09-03 15:28:10`);
    } catch (error) {
